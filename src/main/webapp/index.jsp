				...
				<form method ="POST" action="Init">
					...
					<div class="col-xs-12 col-md-6 col-sm-6 col-lg-6">
						<div class="input-group">
			  				...
			  				<input type="text" class="form-control" placeholder="Pseudo" name="pseudo" aria-describedby="basic-addon1" required="required">
			  			</div>
		  			</div>
		  			<div class="col-xs-12 col-md-6 col-sm-6 col-lg-6">
						<div class="input-group">
			 				 <span class="input-group-addon" id="basic-addon2"><i class="glyphicon glyphicon-home"></i></span>
			  				<input id="basicaddon2input" type="text" class="form-control" placeholder="salon" name="salon" aria-describedby="basic-addon2" required="required">
