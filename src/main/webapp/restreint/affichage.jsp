...
<div class='row bgall'>
    <div class='col-xs-12 col-md-8 col-sm-8 col-lg-8'>
        <div class='panel panel-info bgelement'>
            <div class='panel-heading'>
                <h3 class='panel-title'>Listes des messages. Salon <b>${salon}</b></h3>
            </div>
    ...
    <div class='col-xs-12 col-md-4 col-sm-4 col-lg-4'>
        <iframe src="${pageContext.request.contextPath}/back-office/user/${salon}" name="user" style="height: 100%;"/>
    </div>
</div>
