				...
				<form method ="POST" action="Init">
					...
					<div class="col-xs-12 col-md-6 col-sm-6 col-lg-6">
						<div class="input-group">
			  				...
			  				<input type="text" class="form-control" placeholder="Nom" name="nom" aria-describedby="basic-addon_nom" required="required">
			  			</div>
					</div>
					<div class="col-xs-12 col-md-6 col-sm-6 col-lg-6">
						<div class="input-group">
			 				 <span class="input-group-addon" id="basic-addon_prenom"><span class="glyphicon glyphicon-comment" aria-hidden="true"></span></span>
			  				<input type="text" class="form-control" placeholder="prenom" name="prenom" aria-describedby="basic-addon_prenom" required="required">
			  			</div>
					</div>
					<div class="col-xs-12 col-md-6 col-sm-6 col-lg-6">
						<div class="input-group">
			 				 <span class="input-group-addon" id="basic-addon_email"><span class="glyphicon glyphicon-envelope" aria-hidden="true"></span></span>
			  				<input type="text" class="form-control" placeholder="Email" name="email" aria-describedby="basic-addon_email" required="required">
			  			</div>
					</div>
					<div class="col-xs-12 col-md-6 col-sm-6 col-lg-6">
						<div class="input-group">
			 				 <span class="input-group-addon" id="basic-addon_pseudo"><span class="glyphicon glyphicon-user" aria-hidden="true"></span></span>
			  				<input type="text" class="form-control" placeholder="pseudo" name="pseudo" aria-describedby="basic-addon_email" required="required">
			  			</div>
